...
class view_Templets extends StatelessWidget {
                      ...
                      TextButton(
                          onPressed: () async {
                            if (All_forms_name.contains(
                              ...
                              Get.snackbar("Error", "This name is already sed");
                            } else {
                              ...
                              for (int i = 0; i < fields_name!.length; i++) {
                                print("Filds name ==== ${fields_name[i]}");
                                Map_Filds_Name[i.toString()] = fields_name![i];
                              }
                              ...
                              for (int i = 0; i < Labels.length; i++) {
                                Map_Leble_Text[i.toString()] = Labels[i];
                              }
                              Map_Leble_Text["UserId"] = "${current_user?.uid}";
                              Map_Leble_Text["Length"] = "${Labels.length}";
                              ...
                              for (int i = 0; i < hints.length; i++) {
                                Map_Hint_Text[i.toString()] = hints[i];
                              }
            ...
            Expanded(
              child: Container(
                ...
                child: GridView.builder(
                  itemCount: Templates_filds.length,
